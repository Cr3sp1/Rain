...
// ===============================================================================
template <typename T> 
inline vector<T> CrossProduct(const vector<T> &a, const vector<T> &b) {
...
// ===============================================================================
template <typename T>
tuple<size_t, size_t> Size(const vector<vector<T>>& matrix) {
...
// ===============================================================================
template <typename T> 
inline T Norm(const vector<T> &a) {
  return sqrt(a*a);
}
...
template <typename T> 
inline vector<T> operator*( T c , const vector<T> &a) {
...
template <typename T> 
inline vector<T> operator*( const vector<T> &a , T c) {
...
// ===============================================================================
template <typename T>
T Det(const vector<vector<T>>& matrix) {
  size_t n_rows, n_cols;
  tie( n_rows, n_cols ) = Size(matrix);
...
// ===============================================================================
template <typename T>
vector<vector<T>> Cofactor(const vector<vector<T>>& matrix) {
  size_t n_rows, n_cols;
  tie( n_rows, n_cols ) = Size(matrix);
