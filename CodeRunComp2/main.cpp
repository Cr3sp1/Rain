...
int main (int argc, char *argv[]){
    ...
    vector<vector<double>> RunOptMapComp = OptMapFit( boxR, Run, 2.*17./49., 2, N_vb-17, dx, nstep_t, N_fit, -0.5 + 2.5*10./19., 2, nstep_v, 0, 1.2*9./19., nstep_v );
    Print( "../data/Run/OptMapCompareR2.dat", RunOptMapComp, 12 );
