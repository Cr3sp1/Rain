...
int main (int argc, char *argv[]){
    ...
    vector<vector<double>> RunMins5 = FindMinFit( boxR, Run, 2.*17./49., 2, N_vb-17, dx, nstep_t, N_fit,  0.9, 0, 2.*24/49, nstep_v/2 );
    Print( "../data/Run/OptFitR09_1.dat", RunMins5, 12 );
