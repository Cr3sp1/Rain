...
int main (int argc, char *argv[]){
    ...
    vector<vector<double>> WalkMins3 = FindMinFit( boxW, Walk, 0, 0.7, N_vb, dx, nstep_t, N_fit, 0.30, 0., 0.7, nstep_v );
    Print( "../data/Walk/OptFit030NNN.dat", WalkMins3, 12 );
    ...
    // Print( "../data/Run/OptFit05N.dat", RunMins2, 12 );
