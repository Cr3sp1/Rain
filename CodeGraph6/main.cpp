...
int main (int argc, char *argv[]){
    ...
    vector<vector<double>> RunMins5 = FindMinFit( boxR, Run, 2.*17./49., 2, N_vb-17, dx, nstep_t, N_fit,  0.8, 2.*25/49, 2, nstep_v/2 );
    Print( "../data/Run/OptFitR08_2.dat", RunMins5, 12 );
