...
int main (int argc, char *argv[]){
    ...
    vector<vector<double>> RunOptMapFit = OptMapFit( boxR, Run, 2.*17./49., 2, N_vb-17, dx, nstep_t, N_fit, 0, 2.*9./19., nstep_v, 1.2*10./19., 1.2, nstep_v );
    Print( "../data/Run/OptMapFitR3.dat", RunOptMapFit, 12 ); 
